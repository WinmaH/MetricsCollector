...
public class Snippets {
  ...
  void writeTimeSeries() throws IOException {
    ...
    resourceLabels.put("instance_id", "\n" +
            "gke-wso2-sp-distributed--default-pool-dac73e9c-055j ");
  ...
  void listTimeSeriesHeaders() throws IOException {
    ...
    long startMillis = System.currentTimeMillis() - (( 20*60*1000));
    TimeInterval interval = TimeInterval.newBuilder()
        .setStartTime(Timestamps.fromMillis(startMillis))
        .setEndTime(Timestamps.fromMillis(System.currentTimeMillis()-(16*60*1000)))
        .build();
